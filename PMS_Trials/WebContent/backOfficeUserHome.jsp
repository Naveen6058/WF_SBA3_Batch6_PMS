...
<body>
	...
	<button onclick="location.href='addCompanyIPO.jsp'">Add
		Company IPO</button>
	...
	<form action="modifyStock.jsp" method="post">
		<table>
			...
			<tr>
				<td><input type="checkbox" name="stock1">&nbsp;</td>
				<td>1</td>
				<td>Stock Name1</td>
				<td>BSE and NSE</td>
				<td>13</td>
			...
			<tr>
				<td><input type="checkbox" name="stock2">&nbsp;</td>
				<td>2</td>
				<td>Stock Name2</td>
				<td>NSE</td>
				<td>21</td>
			...
			<tr>
				<td><input type="checkbox" name="stock3">&nbsp;</td>
				<td>3</td>
				<td>Stock Name3</td>
				<td>BSE</td>
				<td>14</td>
	...
	<form action="modifyCommodity.jsp" method="post">
		<table>
			...
			<tr>
				<td><input type="checkbox" name="com1">&nbsp;</td>
				<td>1</td>
				<td>Crude Oil</td>
				<td>30</td>
			</tr>
			<tr>
				<td><input type="checkbox" name="com2">&nbsp;</td>
				<td>2</td>
				<td>Gold</td>
				<td>700</td>
			</tr>
			<tr>
				<td><input type="checkbox" name="com3">&nbsp;</td>
				<td>3</td>
				<td>Silver</td>
				<td>830</td>
			</tr>
	...
	<button onclick="location.href='addCommodity.jsp'">Add
		Commodity</button>
	...
	<form action="backOfficeUserReportGeneration.jsp" method="get">
		...
		<input type="radio" name="dateRange" id="dateRange">
		<label for="dateRange">Date Range</label> 
		<br>
		<br> 
		<label for="ukey">Investor User key</label>
		<input	type="text" id="ukey" name="investorUserkey" autocomplete="off"	required /> <br> 
		<label for="dateRange">From Date</label>
		<input type="date" id="fDate" name="fromDate"> <br> 
		<label for="dateRange">To Date</label>
		<input type="date" id="tDate" name="toDate"> <br>
		<br>
