...
<body>
	...
	<table>
		<tr>
			...
			<td>Rs. 1000 &nbsp;&nbsp;&nbsp;</td>
			<td><strong>Amount Invested as on date:</strong></td>
			<td>Rs. 5000 &nbsp;&nbsp;&nbsp;</td>
			<td><strong>Amount Earned as on date:</strong></td>
			<td>Rs.300 &nbsp;&nbsp;&nbsp;</td>
		</tr>
	</table>
	<br>
	<a
		href="javascript:window.open('portfolioWallet.jsp', 'Portfolio Wallet', 'width=400,height=250');">Portfolio
		Wallet</a>
	<hr>
	...
	<br>
	<a
		href="javascript:window.open('compareCompany.jsp', 'compare Company', 'width=500,height=450');">Compare
		Companies</a>
	<br>
	...
	<input type="radio" name="report" id="monthly">
	<label for="monthly">Monthly</label>
	<input type="radio" name="report" id="annual">
	<label for="annual">Annual</label>
	<input type="radio" name="report" id="dateRange">
	<label for="dateRange">Date Range</label>
	<br>
	<br>
	<label for="dateRange">From: </label>
	<input type="date" name="report" id="from">
	<label for="dateRange">To: </label>
	<input type="date" name="report" id="to">
	<br>
	<br>
