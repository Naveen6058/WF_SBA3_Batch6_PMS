...
<body>
	...
	<%
		...
		String sqlInvestorDetails = "SELECT *FROM INVESTORSTOCKSCOMMISSIONINFO WHERE (INVESTORSTOCKSCOMMISSIONINFO.USERKEY= '"
		+ userkey + "') AND (INVESTORSTOCKSCOMMISSIONINFO.DATE BETWEEN '" + fromDate + "' AND '" + toDate + "');";
		Statement statement = connection.createStatement();
		ResultSet resultSet = statement.executeQuery(sqlInvestorDetails);
		while (resultSet.next()) {
	%>
	<h2>
		Report for Investor User -
		<%=userkey%></h2>
	<div align="center">
